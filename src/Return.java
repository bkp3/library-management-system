...
PreparedStatement pst;
    ...
    {
        String sql="insert into ret_book(Student_ID,SName,FName,Course,Branch,Year,Semester,Book_ID,Name,Edition,Publisher,Price,Pages,Date_Of_Issue,Date_Of_Return) values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
        try
        {
            pst=conn.prepareStatement(sql);
            pst.setString(1,jTextField1.getText());
